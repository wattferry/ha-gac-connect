"""Buttons: force refresh, charge now/pause, sound horn, battery preconditioning."""
...
BUTTONS: tuple[GacButton, ...] = (
    ...
    GacButton(key="horn", translation_key="horn", icon="mdi:bullhorn",
              press=lambda c, vin: c.command(vin, "horn-on")),
